(function () {
  ...
  function mountWidget(root, options) {
    ...
    style.textContent = [
      ...
      ".mzw-card { background: #ffffff; border-radius: 20px; padding: 36px 32px 32px; box-shadow: 0 24px 64px rgba(0, 0, 0, 0.08), 0 0 0 1px rgba(148, 163, 184, 0.10); color: #0f172a; max-width: 480px; display: flex; flex-direction: column; position: relative; overflow: hidden; }",
      ...
      ".mzw-header { margin-bottom: 32px; position: relative; z-index: 1; }",
      ...
      ".mzw-dropzone { margin-top: 0; position: relative; border-radius: 24px; background: rgba(255, 255, 255, 0.4); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); padding: 64px 40px; text-align: center; cursor: pointer; transition: all 0.4s cubic-bezier(0.16, 1, 0.3, 1); border: 1px solid rgba(var(--mzw-spark), 0.08); box-shadow: 0 1px 3px rgba(15, 23, 42, 0.04), 0 0 0 1px rgba(255, 255, 255, 0.6) inset; }",
      ".mzw-dropzone:hover { background: rgba(255, 255, 255, 0.6); border-color: rgba(var(--mzw-spark), 0.20); transform: translateY(-2px); box-shadow: 0 8px 32px rgba(var(--mzw-deep), 0.08), 0 2px 8px rgba(var(--mzw-spark), 0.06), 0 0 0 1px rgba(255, 255, 255, 0.8) inset; }",
      ".mzw-dropzone.mzw-dropzone--active { background: rgba(var(--mzw-spark), 0.08); border-color: rgba(var(--mzw-spark), 0.30); box-shadow: 0 12px 48px rgba(var(--mzw-deep), 0.12), 0 0 0 1px rgba(var(--mzw-spark), 0.20) inset; }",
      ".mzw-drop-icon { position: relative; width: 56px; height: 56px; border-radius: 16px; background: linear-gradient(135deg, rgb(var(--mzw-deep)) 0%, rgb(var(--mzw-spark)) 100%); display: inline-flex; align-items: center; justify-content: center; margin: 0 auto 20px; box-shadow: 0 4px 16px rgba(var(--mzw-deep), 0.16), 0 0 0 1px rgba(255,255,255,0.08) inset; transition: all 0.4s cubic-bezier(0.16, 1, 0.3, 1); }",
      ".mzw-dropzone:hover .mzw-drop-icon { transform: translateY(-2px); box-shadow: 0 8px 24px rgba(var(--mzw-deep), 0.20), 0 0 0 1px rgba(255,255,255,0.12) inset; }",
      ".mzw-drop-icon-svg { width: 28px; height: 28px; color: #ffffff; opacity: 0.95; }",
      ".mzw-drop-title { font-size: 17px; font-weight: 600; color: #0f172a; letter-spacing: -0.02em; margin-bottom: 8px; }",
      ".mzw-drop-helper { font-size: 14px; color: #64748b; font-weight: 400; line-height: 1.5; }",
      ".mzw-drop-limit { margin-top: 12px; font-size: 12px; color: #94a3b8; font-weight: 400; }",
      ...
      ".mzw-photos-row { margin-top: 24px; display: flex; gap: 10px; flex-wrap: wrap; }",
      ...
      ".mzw-results { margin-top: 20px; border-radius: 16px; background: #ffffff; border: 1px solid rgba(148, 163, 184, 0.15); padding: 20px; max-height: 360px; overflow: auto; color: #0f172a; box-shadow: 0 4px 12px rgba(15, 23, 42, 0.06); }",
      ...
      "@media (max-width: 640px) { .mzw-card { max-width: 100%; padding: 28px 24px 24px; border-radius: 16px; } .mzw-title { font-size: 23px; } .mzw-subtitle { font-size: 14px; } .mzw-trust { flex-direction: column; gap: 10px; align-items: flex-start; padding: 12px 14px; } .mzw-trust-divider { display: none; } .mzw-dropzone { padding: 40px 24px; } .mzw-drop-icon { width: 56px; height: 56px; } }",
    ].join("");
