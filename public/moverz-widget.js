(function () {
  ...
  function mountWidget(root, options) {
    ...
    style.textContent = [
      ...
      ".mzw-card { background: linear-gradient(135deg, #ffffff 0%, #f8fafc 100%); border-radius: 20px; padding: 32px 28px; box-shadow: 0 10px 40px rgba(15, 23, 42, 0.10), 0 0 0 1px rgba(var(--mzw-spark), 0.10); color: #0f172a; max-width: 460px; display: flex; flex-direction: column; position: relative; overflow: hidden; }",
      ".mzw-card::before { content: ''; position: absolute; top: 0; left: 0; right: 0; height: 3px; background: linear-gradient(90deg, rgb(var(--mzw-deep)), rgb(var(--mzw-spark))); }",
      ".mzw-header { margin-bottom: 28px; position: relative; z-index: 1; }",
      ".mzw-badge { display: inline-flex; align-items: center; gap: 6px; padding: 5px 11px; border-radius: 999px; background: linear-gradient(135deg, rgba(var(--mzw-deep), 0.10), rgba(var(--mzw-spark), 0.10)); border: 1px solid rgba(var(--mzw-spark), 0.25); color: rgb(var(--mzw-deep)); font-size: 11px; font-weight: 700; letter-spacing: 0.02em; }",
      ".mzw-badge-dot { width: 6px; height: 6px; border-radius: 999px; background: linear-gradient(135deg, rgb(var(--mzw-deep)), rgb(var(--mzw-spark))); animation: mzw-pulse 2s ease-in-out infinite; }",
      "@keyframes mzw-pulse { 0%, 100% { opacity: 1; } 50% { opacity: 0.6; } }",
      ".mzw-title { margin-top: 16px; font-size: 23px; font-weight: 700; line-height: 1.25; color: #0f172a; letter-spacing: -0.02em; }",
      ...
      ".mzw-benefit { display: flex; align-items: center; gap: 6px; padding: 6px 12px; border-radius: 999px; background: rgba(var(--mzw-spark), 0.08); border: 1px solid rgba(var(--mzw-spark), 0.20); font-size: 12px; color: rgb(var(--mzw-deep)); font-weight: 600; }",
      ".mzw-benefit-icon { font-size: 11px; }",
      ".mzw-dropzone { margin-top: 0; border: 2px dashed rgba(var(--mzw-spark), 0.35); border-radius: 16px; background: linear-gradient(135deg, rgba(var(--mzw-deep), 0.03) 0%, rgba(var(--mzw-spark), 0.06) 100%); padding: 36px 28px; text-align: center; cursor: pointer; transition: all 0.2s ease; position: relative; }",
      ".mzw-dropzone:hover { border-color: rgba(var(--mzw-spark), 0.60); background: linear-gradient(135deg, rgba(var(--mzw-deep), 0.06) 0%, rgba(var(--mzw-spark), 0.10) 100%); transform: translateY(-2px); box-shadow: 0 8px 20px rgba(var(--mzw-spark), 0.12); }",
      ".mzw-dropzone.mzw-dropzone--active { border-color: rgb(var(--mzw-spark)); background: linear-gradient(135deg, rgba(var(--mzw-deep), 0.08) 0%, rgba(var(--mzw-spark), 0.14) 100%); border-style: solid; }",
      ".mzw-drop-icon { width: 56px; height: 56px; border-radius: 14px; background: linear-gradient(135deg, rgb(var(--mzw-deep)), rgb(var(--mzw-spark))); display: inline-flex; align-items: center; justify-content: center; margin: 0 auto 16px; box-shadow: 0 6px 16px rgba(var(--mzw-deep), 0.20); }",
      ".mzw-drop-icon-svg { width: 28px; height: 28px; color: #ffffff; }",
      ".mzw-drop-title { font-size: 16px; font-weight: 700; color: #0f172a; letter-spacing: -0.01em; }",
      ".mzw-drop-helper { margin-top: 6px; font-size: 13px; color: #64748b; font-weight: 500; }",
      ".mzw-camera { margin-top: 20px; border-radius: 16px; border: 1px solid rgba(var(--mzw-spark), 0.25); background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); padding: 16px; box-shadow: 0 6px 20px rgba(15, 23, 42, 0.20); }",
      ...
      ".mzw-camera-pill-btn { border-radius: 10px; padding: 8px 14px; font-size: 12px; font-weight: 700; border: none; cursor: pointer; transition: all 0.15s ease; }",
      ".mzw-camera-pill-btn-primary { background: linear-gradient(135deg, rgb(var(--mzw-deep)), rgb(var(--mzw-spark))); color: #ffffff; box-shadow: 0 4px 12px rgba(var(--mzw-spark), 0.30); }",
      ".mzw-camera-pill-btn-primary:hover { transform: translateY(-1px); box-shadow: 0 6px 16px rgba(var(--mzw-spark), 0.40); }",
      ".mzw-camera-pill-btn-secondary { border: 1px solid rgba(148, 163, 184, 0.30); background: rgba(255, 255, 255, 0.08); color: #e2e8f0; }",
      ".mzw-camera-pill-btn-secondary:hover { background: rgba(255, 255, 255, 0.12); }",
      ".mzw-camera-video-wrapper { margin-top: 12px; border-radius: 14px; overflow: hidden; border: 2px solid rgba(var(--mzw-spark), 0.25); background: #000000; }",
      ...
      ".mzw-photo-pill { border-radius: 999px; background: linear-gradient(135deg, rgba(var(--mzw-deep), 0.08), rgba(var(--mzw-spark), 0.08)); border: 1px solid rgba(var(--mzw-spark), 0.25); padding: 6px 12px; font-size: 13px; display: inline-flex; align-items: center; gap: 8px; white-space: nowrap; color: #0f172a; font-weight: 600; }",
      ".mzw-photo-pill-count { width: 20px; height: 20px; border-radius: 999px; background: linear-gradient(135deg, rgb(var(--mzw-deep)), rgb(var(--mzw-spark))); display: flex; align-items: center; justify-content: center; font-size: 11px; color: #ffffff; font-weight: 700; }",
      ".mzw-photo-pill-remove { cursor: pointer; opacity: 0.60; font-size: 15px; font-weight: 600; transition: all 0.15s ease; margin-left: 4px; }",
      ".mzw-photo-pill-remove:hover { opacity: 1; transform: scale(1.1); }",
      ".mzw-summary { margin-top: 16px; display: flex; justify-content: flex-end; }",
      ".mzw-summary-pill { font-size: 12px; padding: 6px 14px; border-radius: 999px; background: linear-gradient(135deg, rgb(var(--mzw-deep)), rgb(var(--mzw-spark))); color: #ffffff; font-weight: 700; box-shadow: 0 4px 12px rgba(var(--mzw-spark), 0.25); }",
      ".mzw-footer { margin-top: 24px; display: flex; flex-direction: column; gap: 12px; }",
      ".mzw-primary-btn { position: relative; overflow: hidden; border: none; border-radius: 12px; padding: 14px 24px; font-size: 15px; font-weight: 700; cursor: pointer; display: inline-flex; align-items: center; justify-content: center; gap: 8px; background: linear-gradient(135deg, rgb(var(--mzw-deep)), rgb(var(--mzw-spark))); color: #ffffff; box-shadow: 0 6px 20px rgba(var(--mzw-deep), 0.25); transition: all 0.2s ease; }",
      ...
      ".mzw-primary-btn:not([disabled]):hover { transform: translateY(-2px); box-shadow: 0 10px 28px rgba(var(--mzw-deep), 0.35); }",
      ".mzw-primary-btn:not([disabled]):active { transform: translateY(0); }",
      ".mzw-primary-btn-chevron { font-size: 15px; }",
      ...
      ".mzw-link { appearance: none; border: none; background: transparent; padding: 0; margin: 0; font-size: 13px; color: #64748b; font-weight: 600; cursor: pointer; text-decoration: underline; text-decoration-thickness: 1px; text-underline-offset: 3px; transition: all 0.15s ease; }",
      ".mzw-link:hover { color: rgb(var(--mzw-deep)); text-decoration-thickness: 2px; }",
      ".mzw-error { margin-top: 12px; font-size: 13px; color: #dc2626; font-weight: 600; padding: 12px 14px; background: rgba(220, 38, 38, 0.08); border-radius: 12px; border: 1px solid rgba(220, 38, 38, 0.20); }",
      ".mzw-results { margin-top: 16px; border-radius: 16px; background: linear-gradient(135deg, #ffffff 0%, #f8fafc 100%); border: 1px solid rgba(var(--mzw-spark), 0.25); padding: 16px; max-height: 340px; overflow: auto; color: #0f172a; box-shadow: 0 4px 16px rgba(var(--mzw-spark), 0.10); }",
      ".mzw-results-header { display: flex; justify-content: space-between; align-items: center; gap: 10px; margin-bottom: 14px; padding-bottom: 12px; border-bottom: 1px solid rgba(var(--mzw-spark), 0.20); }",
      ...
      ".mzw-item { border-radius: 12px; background: #ffffff; padding: 12px 14px; border: 1px solid rgba(var(--mzw-spark), 0.20); transition: all 0.15s ease; box-shadow: 0 2px 8px rgba(15, 23, 42, 0.04); }",
      ".mzw-item:hover { border-color: rgba(var(--mzw-spark), 0.40); transform: translateY(-1px); box-shadow: 0 4px 12px rgba(var(--mzw-spark), 0.12); }",
      ...
      ".mzw-chip { border-radius: 999px; background: linear-gradient(135deg, rgba(var(--mzw-deep), 0.10), rgba(var(--mzw-spark), 0.10)); padding: 3px 9px; font-size: 11px; color: rgb(var(--mzw-deep)); font-weight: 700; border: 1px solid rgba(var(--mzw-spark), 0.25); }",
      ".mzw-chip-outline { border-radius: 999px; border: 1px solid rgba(148, 163, 184, 0.30); padding: 3px 9px; font-size: 11px; color: #64748b; background: rgba(248, 250, 252, 0.50); font-weight: 600; }",
      ...
      "@media (max-width: 640px) { .mzw-card { max-width: 100%; padding: 28px 20px; border-radius: 16px; } .mzw-title { font-size: 21px; } .mzw-subtitle { font-size: 13px; } .mzw-dropzone { padding: 32px 24px; } .mzw-primary-btn { padding: 13px 20px; font-size: 14px; } .mzw-benefits { flex-direction: column; gap: 8px; } }",
    ].join("");
