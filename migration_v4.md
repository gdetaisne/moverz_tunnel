...
- **Décisions / Correctifs**:
  ...
  - UI: sur desktop, Densité + Cuisine sont présentés en **grille** (plus compact) et rattachés visuellement au **logement de départ** (breakpoints ajustés pour être plus “desktop”).
- **Tracking**:
